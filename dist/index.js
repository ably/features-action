...
const { Manifest } = __nccwpck_require__(46);
const { MatrixGenerator } = __nccwpck_require__(91);
const { writeDocument } = __nccwpck_require__(454);
const { validateStructure } = __nccwpck_require__(398);
const { isString } = __nccwpck_require__(699);
...
const fs = __nccwpck_require__(147);
const escape = __nccwpck_require__(70);
const { marked } = __nccwpck_require__(741);
const {
  DocumentWriter,
  TableWriter,
} = __nccwpck_require__(656);
const { MatrixGenerator, MatrixConsumer } = __nccwpck_require__(91);
...
const { compareKeys } = __nccwpck_require__(782);
const { Manifest } = __nccwpck_require__(46);
const { isPropertyKey, Properties } = __nccwpck_require__(144);
...
const { build, ManifestObjects } = __nccwpck_require__(772);
